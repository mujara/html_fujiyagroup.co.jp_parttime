...
require([
  ...
  "luminous.min",			//画像用モーダルウィンドウJS
	...
	var modalOverlayGlobalNavi = document.querySelector('#modalOverlayGlobalNavi');
	modalOverlayGlobalNavi.addEventListener( 'click' , btn_is_open );
	...
	function btn_is_open(){
		if( globalNaviSmallIcon.classList.contains("is-open") == true ){
			...
			MicroModal.show('modal-globalNaviSmall', {
			       disableScroll: false, // ページスクロールを無効に
